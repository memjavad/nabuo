...
class Settings_Center {
	...
	public function render_page() {
		...
		<div class="wrap naboo-admin-page naboo-settings-wrap" style="font-family: 'Inter', sans-serif;">
			<?php
			$this->render_header();
			settings_errors( 'naboodatabase_settings_group' );
			$this->render_styles();
			$this->render_tab_navigation();
			$this->render_form_content( $options );
			$this->render_scripts();
			?>
		</div>
		<?php
	...
	/**
	 * Render inline styles for the settings page
	 */
	...
	/**
	 * Render form content containing all tabs
	 *
	 * @param array $options Current settings options.
	 */
	private function render_form_content( $options ) {
		?>
	...
	/**
	 * Render scripts for tab switching
	 */
