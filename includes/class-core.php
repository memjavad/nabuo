...
class Core {
	...
	private function define_admin_hooks() {
		...
		$this->define_admin_performance_security_hooks();
		$this->define_admin_moderation_hooks();
		$this->define_admin_tools_hooks();
		$this->define_admin_reporting_hooks();
	}
	...
	private function define_admin_performance_security_hooks() {
	...
	private function define_admin_tools_hooks() {
	...
	private function define_admin_reporting_hooks() {
