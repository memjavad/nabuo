...
= 1.55.11 =
* ⚡ Performance: Added missing `no_found_rows` to unpaginated WP_Query lookups, preventing inefficient `SQL_CALC_FOUND_ROWS` queries on unpaginated admin views and REST API endpoints.
