...
= 1.55.11 =
* Refactor: Split `define_admin_hooks` into smaller `define_admin_core_hooks`, `define_admin_tools_hooks`, and `define_admin_system_hooks` methods for better maintainability.
= 1.55.8 =
