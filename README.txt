...
== Changelog ==
= 1.55.11 =
* Security: Fixed SQL Injection vulnerability in Contributor Management update_all_contributor_stats method.
* Changed: Increased minimum WordPress version requirement to 6.2 for identifier escaping placeholder support.
...
* Updated API test handler to use Gemma 4 4B Effective for connectivity testing.
